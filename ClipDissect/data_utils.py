...
dataset_keys = config.options(section_name)
...
def get_data(dataset_name, preprocess=None):
    ...
    elif dataset_name in dataset_keys:
        data = datasets.ImageFolder(config.get(section_name, dataset_name), preprocess)
               
    elif dataset_name == "imagenet_broden":
        data = torch.utils.data.ConcatDataset([datasets.ImageFolder(config.get(section_name, "imagenet_val"), preprocess), 
                                                     datasets.ImageFolder(config.get(section_name, "broden"), preprocess)])
