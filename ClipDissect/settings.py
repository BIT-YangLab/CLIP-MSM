...
MODEL = 'clip resnet50'                          # model arch: resnet18, alexnet, resnet50, densenet161
DATASET = 'coco'                       # model trained on: places365 or imagenet
...
CATAGORIES = ["object", "part","material"] # concept categories that are chosen to detect: "object", "part", "scene", "material", "texture", "color"
...
# DATA_DIRECTORY = 'data/floc_image/floc-image'
# # IMG_SIZE = 1024
